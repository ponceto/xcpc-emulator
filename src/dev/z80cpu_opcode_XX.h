...
case ADD_H:    M_ADD(z80cpu->XX.B.h);break;
case ADD_L:    M_ADD(z80cpu->XX.B.l);break;
case ADD_A:    M_ADD(z80cpu->AF.B.h);break;
case ADD_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_ADD(I);break;
...
case SUB_H:    M_SUB(z80cpu->XX.B.h);break;
case SUB_L:    M_SUB(z80cpu->XX.B.l);break;
case SUB_A:    z80cpu->AF.B.h=0;z80cpu->AF.B.l=N_FLAG|Z_FLAG;break;
case SUB_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_SUB(I);break;
...
case AND_H:    M_AND(z80cpu->XX.B.h);break;
case AND_L:    M_AND(z80cpu->XX.B.l);break;
case AND_A:    M_AND(z80cpu->AF.B.h);break;
case AND_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_AND(I);break;
case AND_BYTE: I=RdZ80(z80cpu->PC.W++);M_AND(I);break;

case OR_B:     M_IOR(z80cpu->BC.B.h);break;
case OR_C:     M_IOR(z80cpu->BC.B.l);break;
case OR_D:     M_IOR(z80cpu->DE.B.h);break;
case OR_E:     M_IOR(z80cpu->DE.B.l);break;
case OR_H:     M_IOR(z80cpu->XX.B.h);break;
case OR_L:     M_IOR(z80cpu->XX.B.l);break;
case OR_A:     M_IOR(z80cpu->AF.B.h);break;
case OR_xHL:   I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_IOR(I);break;
...
case ADC_H:    M_ADC(z80cpu->XX.B.h);break;
case ADC_L:    M_ADC(z80cpu->XX.B.l);break;
case ADC_A:    M_ADC(z80cpu->AF.B.h);break;
case ADC_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_ADC(I);break;
...
case SBC_H:    M_SBC(z80cpu->XX.B.h);break;
case SBC_L:    M_SBC(z80cpu->XX.B.l);break;
case SBC_A:    M_SBC(z80cpu->AF.B.h);break;
case SBC_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_SBC(I);break;
...
case XOR_H:    M_XOR(z80cpu->XX.B.h);break;
case XOR_L:    M_XOR(z80cpu->XX.B.l);break;
case XOR_A:    z80cpu->AF.B.h=0;z80cpu->AF.B.l=P_FLAG|Z_FLAG;break;
case XOR_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_XOR(I);break;
case XOR_BYTE: I=RdZ80(z80cpu->PC.W++);M_XOR(I);break;

case CP_B:     M_CMP(z80cpu->BC.B.h);break;
case CP_C:     M_CMP(z80cpu->BC.B.l);break;
case CP_D:     M_CMP(z80cpu->DE.B.h);break;
case CP_E:     M_CMP(z80cpu->DE.B.l);break;
case CP_H:     M_CMP(z80cpu->XX.B.h);break;
case CP_L:     M_CMP(z80cpu->XX.B.l);break;
case CP_A:     z80cpu->AF.B.l=N_FLAG|Z_FLAG;break;
case CP_xHL:   I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));
               M_CMP(I);break;
...
case LD_PC_HL: z80cpu->PC.W=z80cpu->XX.W;break;
case LD_SP_HL: z80cpu->SP.W=z80cpu->XX.W;break;
...
case DEC_H:    M_DEC(z80cpu->XX.B.h);break;
case DEC_L:    M_DEC(z80cpu->XX.B.l);break;
case DEC_A:    M_DEC(z80cpu->AF.B.h);break;
case DEC_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W));M_DEC(I);
               WrZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++),I);
               break;
...
case INC_H:    M_INC(z80cpu->XX.B.h);break;
case INC_L:    M_INC(z80cpu->XX.B.l);break;
case INC_A:    M_INC(z80cpu->AF.B.h);break;
case INC_xHL:  I=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W));M_INC(I);
               WrZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++),I);
               break;
...
case LD_H_B:   z80cpu->XX.B.h=z80cpu->BC.B.h;break;
case LD_L_B:   z80cpu->XX.B.l=z80cpu->BC.B.h;break;
case LD_A_B:   z80cpu->AF.B.h=z80cpu->BC.B.h;break;
case LD_xHL_B: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->BC.B.h);break;
...
case LD_H_C:   z80cpu->XX.B.h=z80cpu->BC.B.l;break;
case LD_L_C:   z80cpu->XX.B.l=z80cpu->BC.B.l;break;
case LD_A_C:   z80cpu->AF.B.h=z80cpu->BC.B.l;break;
case LD_xHL_C: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->BC.B.l);break;
...
case LD_H_D:   z80cpu->XX.B.h=z80cpu->DE.B.h;break;
case LD_L_D:   z80cpu->XX.B.l=z80cpu->DE.B.h;break;
case LD_A_D:   z80cpu->AF.B.h=z80cpu->DE.B.h;break;
case LD_xHL_D: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->DE.B.h);break;
...
case LD_H_E:   z80cpu->XX.B.h=z80cpu->DE.B.l;break;
case LD_L_E:   z80cpu->XX.B.l=z80cpu->DE.B.l;break;
case LD_A_E:   z80cpu->AF.B.h=z80cpu->DE.B.l;break;
case LD_xHL_E: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->DE.B.l);break;

case LD_B_H:   z80cpu->BC.B.h=z80cpu->XX.B.h;break;
case LD_C_H:   z80cpu->BC.B.l=z80cpu->XX.B.h;break;
case LD_D_H:   z80cpu->DE.B.h=z80cpu->XX.B.h;break;
case LD_E_H:   z80cpu->DE.B.l=z80cpu->XX.B.h;break;
case LD_H_H:   z80cpu->XX.B.h=z80cpu->XX.B.h;break;
case LD_L_H:   z80cpu->XX.B.l=z80cpu->XX.B.h;break;
case LD_A_H:   z80cpu->AF.B.h=z80cpu->XX.B.h;break;
case LD_xHL_H: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->HL.B.h);break;

case LD_B_L:   z80cpu->BC.B.h=z80cpu->XX.B.l;break;
case LD_C_L:   z80cpu->BC.B.l=z80cpu->XX.B.l;break;
case LD_D_L:   z80cpu->DE.B.h=z80cpu->XX.B.l;break;
case LD_E_L:   z80cpu->DE.B.l=z80cpu->XX.B.l;break;
case LD_H_L:   z80cpu->XX.B.h=z80cpu->XX.B.l;break;
case LD_L_L:   z80cpu->XX.B.l=z80cpu->XX.B.l;break;
case LD_A_L:   z80cpu->AF.B.h=z80cpu->XX.B.l;break;
case LD_xHL_L: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->HL.B.l);break;
...
case LD_H_A:   z80cpu->XX.B.h=z80cpu->AF.B.h;break;
case LD_L_A:   z80cpu->XX.B.l=z80cpu->AF.B.h;break;
case LD_A_A:   z80cpu->AF.B.h=z80cpu->AF.B.h;break;
case LD_xHL_A: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
               WrZ80(J.W,z80cpu->AF.B.h);break;

case LD_xBC_A: WrZ80(z80cpu->BC.W,z80cpu->AF.B.h);break;
case LD_xDE_A: WrZ80(z80cpu->DE.W,z80cpu->AF.B.h);break;

case LD_B_xHL:    z80cpu->BC.B.h=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
case LD_C_xHL:    z80cpu->BC.B.l=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
case LD_D_xHL:    z80cpu->DE.B.h=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
case LD_E_xHL:    z80cpu->DE.B.l=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
case LD_H_xHL:    z80cpu->HL.B.h=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
case LD_L_xHL:    z80cpu->HL.B.l=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
case LD_A_xHL:    z80cpu->AF.B.h=RdZ80(z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++));break;
...
case LD_H_BYTE:   z80cpu->XX.B.h=RdZ80(z80cpu->PC.W++);break;
case LD_L_BYTE:   z80cpu->XX.B.l=RdZ80(z80cpu->PC.W++);break;
case LD_A_BYTE:   z80cpu->AF.B.h=RdZ80(z80cpu->PC.W++);break;
case LD_xHL_BYTE: J.W=z80cpu->XX.W+(gint8)RdZ80(z80cpu->PC.W++);
                  WrZ80(J.W,RdZ80(z80cpu->PC.W++));break;

case LD_xWORD_HL:
  J.B.l=RdZ80(z80cpu->PC.W++);
  J.B.h=RdZ80(z80cpu->PC.W++);
  WrZ80(J.W++,z80cpu->XX.B.l);
  WrZ80(J.W,z80cpu->XX.B.h);
  break;

case LD_HL_xWORD:
  J.B.l=RdZ80(z80cpu->PC.W++);
  J.B.h=RdZ80(z80cpu->PC.W++);
  z80cpu->XX.B.l=RdZ80(J.W++);
  z80cpu->XX.B.h=RdZ80(J.W);
  break;
...
case EX_HL_xSP:
  J.B.l=RdZ80(z80cpu->SP.W);WrZ80(z80cpu->SP.W++,z80cpu->XX.B.l);
  J.B.h=RdZ80(z80cpu->SP.W);WrZ80(z80cpu->SP.W--,z80cpu->XX.B.h);
  z80cpu->XX.W=J.W;
  break;
