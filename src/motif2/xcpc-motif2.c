/*
 * xcpc-motif2.c - Copyright (c) 2001-2024 - Olivier Poncet
 *
...
static void LegalCallback(Widget widget, XcpcApplication* self, XtPointer info)
{
    Arg      arglist[16];
    Cardinal argcount = 0;
    XmString title = XmStringCreateLocalized(_("Legal informations ..."));
...
static XcpcApplication* BuildHelpMenu(XcpcApplication* self)
{
    ...
    /* help-legal */ {
        XmString string = XmStringCreateLocalized(_("Legal informations"));
        argcount = 0;
        XtSetArg(arglist[argcount], XmNlabelString, string); ++argcount;
