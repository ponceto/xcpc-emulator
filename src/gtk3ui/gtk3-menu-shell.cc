/*
 * gtk3-menu-shell.cc - Copyright (c) 2001-2025 - Olivier Poncet
 *
...
using traits = gtk3::MenuShellTraits;
...
MenuShell::MenuShell()
    : MenuShell(traits::create_menu_shell())
{
}

MenuShell::MenuShell(GtkWidget* instance)
    : Container(instance)
{
}
