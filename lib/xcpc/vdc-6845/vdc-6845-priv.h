...
#define DEFAULT_VALUE_OF_HORIZONTAL_DISPLAYED     0x28 /*      40 */
#define DEFAULT_VALUE_OF_HORIZONTAL_SYNC_POSITION 0x2e /*      46 */
#define DEFAULT_VALUE_OF_SYNC_WIDTH               0x0e /* 16 + 14 */
#define DEFAULT_VALUE_OF_VERTICAL_TOTAL           0x26 /*      38 */
#define DEFAULT_VALUE_OF_VERTICAL_TOTAL_ADJUST    0x00 /*       0 */
#define DEFAULT_VALUE_OF_VERTICAL_DISPLAYED       0x19 /*      25 */
#define DEFAULT_VALUE_OF_VERTICAL_SYNC_POSITION   0x1e /*      30 */
#define DEFAULT_VALUE_OF_INTERLACE_MODE_AND_SKEW  0x00 /*       0 */
#define DEFAULT_VALUE_OF_MAXIMUM_SCANLINE_ADDRESS 0x07 /*       7 */
#define DEFAULT_VALUE_OF_CURSOR_START             0x00 /*       0 */
#define DEFAULT_VALUE_OF_CURSOR_END               0x00 /*       0 */
#define DEFAULT_VALUE_OF_START_ADDRESS_HIGH       0x30 /*      48 */
#define DEFAULT_VALUE_OF_START_ADDRESS_LOW        0x00 /*       0 */
#define DEFAULT_VALUE_OF_CURSOR_HIGH              0x00 /*       0 */
#define DEFAULT_VALUE_OF_CURSOR_LOW               0x00 /*       0 */
#define DEFAULT_VALUE_OF_LIGHT_PEN_HIGH           0x00 /*       0 */
#define DEFAULT_VALUE_OF_LIGHT_PEN_LOW            0x00 /*       0 */
