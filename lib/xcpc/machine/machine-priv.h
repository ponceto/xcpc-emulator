...
extern unsigned long xcpc_machine_attach_func    (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_detach_func    (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_realize_func   (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_unrealize_func (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_resize_func    (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_expose_func    (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_input_func     (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
extern unsigned long xcpc_machine_clock_func     (XcpcMachine* machine, XEvent* event, XcpcBackendData* data);
