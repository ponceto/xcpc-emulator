...
extern unsigned long xcpc_machine_realize_func   (XcpcMachine* machine, XcpcBackendClosure* closure);
extern unsigned long xcpc_machine_unrealize_func (XcpcMachine* machine, XcpcBackendClosure* closure);
extern unsigned long xcpc_machine_resize_func    (XcpcMachine* machine, XcpcBackendClosure* closure);
extern unsigned long xcpc_machine_expose_func    (XcpcMachine* machine, XcpcBackendClosure* closure);
extern unsigned long xcpc_machine_input_func     (XcpcMachine* machine, XcpcBackendClosure* closure);
